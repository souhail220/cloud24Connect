...
export default function FeatureCard({feature, key}: Readonly<FeatureCardProps>) {
    ...
    return (
        ...
        >
            <div
                className="mt-2 inset-0 flex flex-col items-center justify-center text-center transition-all duration-500 group-hover:-translate-y-8 sm:group-hover:-translate-y-12">
