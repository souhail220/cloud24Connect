...
const features = [
  {
    icon: (
      <Zap className="text-secondary-dark w-14 h-14  mb-4 group-hover:text-white" />
    ),
  ...
  {
    icon: (
      <ShieldCheck className="text-secondary-dark w-14 h-14 mb-4 group-hover:text-white" />
    ),
  ...
  {
    icon: (
      <Video className="text-secondary-dark w-14 h-14 mb-4 group-hover:text-white" />
    ),
  ...
  {
    icon: (
      <Cloud className="text-secondary-dark w-14 h-14 mb-4 group-hover:text-white" />
    ),
  ...
  {
    icon: (
      <Network className="text-secondary-dark w-14 h-14 mb-4 group-hover:text-white" />
    ),
  ...
  {
    icon: (
      <Database className="text-secondary-dark w-14 h-14 mb-4 group-hover:text-white" />
    ),
    ...
    <div className="text-center px-6 mt-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-9">
        {features.map((feature, i) => (
            <div
                key={i}
                className="card-container group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform duration-300 hover:bg-[#2b39cf] overflow-hidden h-64"
            >
