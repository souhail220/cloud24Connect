...
import SpotlightCard from "./components/SpotlighCard.tsx";
                ...
                <div className="mt-24 grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    <Link to="/docs#quick-setup">
                        <SpotlightCard
                            ...
                            spotlightColor={theme === 'light' ? "rgba(133, 5, 5, 0.5)" : "rgba(250, 2, 255, 0.4)"}
                        >
                    ...
                    <Link to="/docs#authentication">
                        <SpotlightCard
                            className="custom-spotlight-card"
                            spotlightColor={theme === 'light' ? "rgba(59, 209, 243, 0.5)" : "rgba(250, 2, 255, 0.4)"}
                        >
                            <div className="flex items-center gap-3 mb-4">
                                <div className="p-2 rounded-md bg-muted">
                    ...
                    <Link to="/docs#authentication">
                        ...
                        >
                            ...
                            <p className="dark:text-gray-100 text-gray-800 text-muted-foreground text-sm">
                                Detailed best practices for working with our API, including authentication and project workflows.
                            </p>
                            <span
