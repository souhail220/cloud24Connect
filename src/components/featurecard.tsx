...
export default function Featurecard() {
  return (
      <div className="text-center px-6">
        <h2 className="text-3xl font-bold mb-10 text-orange-500">Our Service Benefits</h2>
        <div className="">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-9">
          {features.map((feature, i) => (
            <div
              key={i}
              className="group bg-gradient rounded-2xl p-8 shadow-lg hover:shadow-2xl transform duration-300 hover:bg-[#2b39cf]"
            >
              <div className="flex flex-col items-center text-center">
                {feature.icon}
                <h3 className="font-bold text-lg text-orange-500 mb-2 group-hover:text-white">{feature.title}</h3>
