...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-[#2b39cf] text-white z-50 shadow">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-8 py-4">
        ...
        <ul className="hidden md:flex items-center gap-8 text-sm font-medium">
          ...
          <div className="absolute top-full left-0 right-0 bg-white text-gray-800 shadow-lg py-6 px-8 opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-300">
            <ul className="grid grid-cols-3 gap-6 text-sm max-w-[1200px] mx-auto">
              <li className="hover:text-blue-500 cursor-pointer">Cloud Servers</li>
              <li className="hover:text-blue-500 cursor-pointer">Cloud Desktop</li>
              <li className="hover:text-blue-500 cursor-pointer">Virtual Private Cloud</li>
              <li className="hover:text-blue-500 cursor-pointer">Firewall</li>
              <li className="hover:text-blue-500 cursor-pointer">Load Balancers</li>
              <li className="hover:text-blue-500 cursor-pointer">Block Storage</li>
            </ul>
          </div>
        </li>
        ...
        <div className="flex items-center gap-4">
          <button className="text-sm hover:border-blue-400 border-white rounded px-4 py-2">Log in</button>
